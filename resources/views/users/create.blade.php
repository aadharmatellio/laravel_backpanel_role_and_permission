            ...
            <form method="POST" action="">
                ...
                <div class="card-header">
                    <h2 class="card-title">
                        ...
                        <strong class="pl-2">Add New User</strong> (Add new user and assign role.)
                    </h2>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-save mr-2"></i>Save user</button>
